 ...
 */
let oldFebruary = dictionary.updateValue(29, forKey: "February")
print(dictionary)
...
if let januaryDays = dictionary["January"] {
    print("January has \(januaryDays) days in it")
}
...
let sholorsDictionary: [String: [String]] = ["Shapes": shapesArray, "Colors": colorsArray]
print(sholorsDictionary)
 ...
 */
if let colorsArray = sholorsDictionary["Blue"] {
    print(colorsArray)
}
