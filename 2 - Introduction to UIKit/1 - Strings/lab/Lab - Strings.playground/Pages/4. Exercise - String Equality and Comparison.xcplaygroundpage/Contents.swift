...
let nameInCaps = "Joe"
let name = "joe"
if nameInCaps == name {print("The two strings are equal")} else {
 ...
 */
if nameInCaps == name.lowercased() {print("They are the same")} else {
...
if junior == "Jr." {print("We found a second generation name!")}
...
if textToSearchThrough.lowercased() == textToSearchFor {print("I found it!")}
