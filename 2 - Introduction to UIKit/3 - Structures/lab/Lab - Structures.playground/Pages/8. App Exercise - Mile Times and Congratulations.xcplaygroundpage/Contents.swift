...
let averageMiles = RunningWorkout (distance: 2900, time: 62, elevation: 1300)

let averageMileTime = averageMiles.distance * averageMiles.time / 2
...
struct Steps {
    ...
    var totalSteps = Steps(steps: 9999, goal: 10000)
