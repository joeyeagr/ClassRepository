 ...
 */
struct User {
    static var currentUser: User = User(userName: "joeyy.eagr", email: "nachosareamazing@gmail.com", age: 17)
    
    static func logIn(currentLoggedInUser: User) {
        currentUser = currentLoggedInUser
        print("\(currentUser.userName) is the one who is currently logged in")
    }
    var userName: String
    var email: String
    var age: Int
 ...
 */
let myNewUser = User(userName: "joeyy.eagr", email: "nachosareamazing@gmail.com", age: 17)
User.logIn(currentLoggedInUser: myNewUser)
