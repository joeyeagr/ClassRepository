...
//print("The value of foo is \(foo)")
print("it will not compile because foo is part of the for in statement")
...
// the reason these lines work when using x is because x is declared globally while foo was declared locally
